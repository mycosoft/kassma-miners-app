              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(child: Text('Add New Worker', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold))),
            ...
            : _error != null
                ...
                : _workers.isEmpty
                    ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Text('Add workers to manage them here', style: TextStyle(color: Colors.grey.shade500)),
                      ]))
                    : ListView.separated(
